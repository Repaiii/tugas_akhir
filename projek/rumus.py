"""def hitung_status(self, queryset):
        ...
        for i in range(len(nilai_V)):
            ...
            bahaya = fuzzy_membership_bahaya(nilai_V[i])
            sedang = fuzzy_membership_sedang(nilai_V[i])
            aman = fuzzy_membership_aman(nilai_V[i])
            ...
            matriks_normalized.append([nilai_V[i], bahaya, sedang, aman, status])
